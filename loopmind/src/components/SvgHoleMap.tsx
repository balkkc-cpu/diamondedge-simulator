...
/**
 * Lightweight, dependency-free schematic hole renderer driven by normalized
 * geometry. Used on native and as a fallback on web when satellite tiles or
 * real geometry aren't available.
 *
 * REAL MAPS on native: swap this for a Mapbox/Google MapView using lat/lng.
 */
export function SvgHoleMap({ hole, selectedTeeId, playerPosition, width, ratio = 1.5 }: HoleMapProps) {
